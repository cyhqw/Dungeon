...
export const EFFECT_FA_ICON_CLASS: Partial<Record<EffectType, string>> = {
  ...
  [ET.BRAND_MARK]: 'fa-brands fa-arch-linux',
  [ET.OBEDIENCE_BRAND]: 'fa-brands fa-arch-linux',
  ...
  [ET.ANESTHESIA_DEPTH]: 'fa-solid fa-burst',
  [ET.LIVING_ROOM]: 'fa-solid fa-worm',
  ...
  [ET.CO_DANCE]: 'fa-brands fa-vsco',
  [ET.SOLITUDE]: 'fa-solid fa-heart-crack',
  [ET.REFLECTION]: 'fa-solid fa-parachute-box',
